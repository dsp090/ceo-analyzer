...
CRITICAL RULES:
1. CEO News Context below is your PRIMARY source — overrides training data for current CEO name.
2. If context says CEO changed in ${new Date().getFullYear()} or ${new Date().getFullYear()-1} — use the NEW CEO name in ceo_name.
3. Named successor in context → incoming_ceo_announced="yes", full name in incoming_ceo_name.
4. Old CEO stepped down in context → ceo_departure_announced="yes".
5. For Apple: if Tim Cook left and John Ternus (or anyone) is named CEO — reflect that.
6. Use knowledge for TSR, revenue, CEO age — do NOT return "not clearly inferable" for major companies.
Return ONLY valid JSON. No markdown.`,
